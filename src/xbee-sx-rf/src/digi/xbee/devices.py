...
from digi.xbee.xbee_serial import FlowControl ###CHANGED THIS
from digi.xbee.xbee_serial import XBeeSerialPort  ### CHANGED THIS
...
class XBeeDevice(AbstractXBeeDevice):
    ...
    def __init__(self, port, baud_rate, data_bits=serial.EIGHTBITS, stop_bits=serial.STOPBITS_ONE,
        ...
        """
        super(XBeeDevice, self).__init__(serial_port=XBeeSerialPort(baud_rate=baud_rate, port=None, data_bits=data_bits, stop_bits=stop_bits, parity=parity, flow_control=flow_control,timeout=_sync_ops_timeout),sync_ops_timeout=_sync_ops_timeout)
        self.__port = port
